...
public class TipActivity extends BasicActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setToolbarTitle("꿀팁 게시판");

        FirebaseStorage storage = FirebaseStorage.getInstance();

        postList = new ArrayList<>();
        bullentinBoardAdapter = new BullentinBoardAdapter(TipActivity.this, postList);
        bullentinBoardAdapter.setOnPostListener(onPostListener);

        RecyclerView recyclerView = findViewById(R.id.recyclerView2);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(TipActivity.this));
        ...
        btn_plus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(TipActivity.this, TipWriteActivity.class);
